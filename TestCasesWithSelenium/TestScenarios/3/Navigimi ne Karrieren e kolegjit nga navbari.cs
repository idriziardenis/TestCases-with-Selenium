...
{
    class Navigimi_ne_Karrieren_e_kolegjit_nga_navbari
    {
        ...
        public void Valid()
        {
            ...
            Driver.driver.FindElement(By.XPath($"//a[@href='https://www.riinvest.net/karriera/']")).Click();

            Thread.Sleep(1000);

            Assert.IsTrue(Driver.driver.PageSource.Contains("Karriera"));
        }
    }
}
